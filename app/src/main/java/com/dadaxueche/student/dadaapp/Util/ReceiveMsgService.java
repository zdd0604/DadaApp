...
public class ReceiveMsgService extends Service {
    ...
    public interface GetConnectState {
        public void GetState(boolean isConnected, boolean isWifi); // 网络状态改变之后，通过此接口的实例通知当前网络的状态，此接口在Activity中注入实例对象
    }
    ...
    class QunXTask extends TimerTask {
        ...
        public void run() {
            ...
            if (onGetConnectState != null) {
                onGetConnectState.GetState(isContected, isWifi); // 通知网络状态改变
            }
        }
