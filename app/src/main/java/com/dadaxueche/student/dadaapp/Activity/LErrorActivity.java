...
public class LErrorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.layout1:
                if (mList.size() > 0) {
                    intent = new Intent(LErrorActivity.this, ExamActivity.class);
    ...
    protected void dialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LErrorActivity.this);
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (database.deleteAllError(KM)) {
                    Toast.makeText(LErrorActivity.this, "清空成功", Toast.LENGTH_SHORT).show();
                    mList.clear();
                    for (int i = 0; i < count.length; i++) {
                        count[i] = 0;
                    }
                    ...
                    Toast.makeText(LErrorActivity.this, "清空失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
