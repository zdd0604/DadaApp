...
public class LK1ExcldeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.k1layout1:
                if (mList.size() > 0) {
                    intent = new Intent(LK1ExcldeActivity.this, ExamActivity.class);
    ...
    protected void dialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(LK1ExcldeActivity.this);
        ...
        builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (database.deleteAllIgnore(KM)) {
                    Toast.makeText(LK1ExcldeActivity.this, "恢复成功", Toast.LENGTH_SHORT).show();
                    mList.clear();
                    for (int i = 0; i < count.length; i++) {
                        count[i] = 0;
                    }
                    ...
                    Toast.makeText(LK1ExcldeActivity.this, "恢复失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
