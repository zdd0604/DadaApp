...
public class KM4Fragment extends Fragment implements
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_wdct:
                Intent intent_wdct = new Intent(getActivity(), LErrorActivity.class);
                intent_wdct.putExtra(flag_Select_KM_Type,KM);
                startActivityForResult(intent_wdct, 100);
                break;
            case R.id.button_wdsc:
                Intent intent_wdsc = new Intent(getActivity(), LCollectActivity.class);
            ...
            case R.id.button_pcdt:
                Intent intent_pcdt = new Intent(getActivity(), LExcludeActivity.class);
            ...
            case R.id.button_kmjj:
                ...
                intent_kmjj.putExtra(flag_Url,"http://www.dadaxueche.com/m/kesi.html");
                intent_kmjj.putExtra(flag_Content,"科四简介");
